...
q0_1=0.75;		%3/4 phase 3 trials made significant improvements
q0_2=0.66;		%4/6 phase 3 trials made significant improvements

C_R_list=10:2:50;
nu_i_R_list=25:5:200;
...
c_G=[0,0];
c_B=[0.5,1.4];	   % in million dollars - $69K for 1 DALY in US
%DALY (equal to one lost year of healthy life) is 
...
mu=[0.113,13.6];		%NCT03525444
rho=[0.016,0.8];		%NCT02729051
...
figure;
plot(C_base,nu_i_base,'*','LineWidth',2);
hold on;
plot(C_rare,nu_i_rare,'+','LineWidth',2);
